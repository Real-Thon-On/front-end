    ...
    <>
      <div className="mt-[1.6rem]">
        ...
        <Default className="flex-col gap-[2.4rem] pt-[2rem] px-[1.2rem] pb-[1.6rem]">
          <div className="flex flex-col gap-[2.4rem]">
            ...
            <div className="w-full body3 max-h-[8rem] break-words">{content}</div>
            <div className="flex items-center">
              <NotHeart />
              <span className="ml-[.4rem]">{heart}</span>
            </div>
          </div>
        </Default>
      </div>
      ...
      >
        <div className="w-full max-w-[43.6rem] h-[8rem] px-[1.2rem] mb-[2rem] border-t border-[var(--gray2)] flex items-center gap-[.8rem]">
          ...
          />
          <button className="btn2 text-[var(--primary)] h-[3.2rem] px-[1.2rem]">
            <CommentUpload />
          </button>
        </div>
      </form>
